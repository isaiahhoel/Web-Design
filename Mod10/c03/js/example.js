...
// Create a hotel object using object literal syntax 
    ...
    specialRate = document.getElementById('specialRate');// Get elements
    ...
    var elEnds;  // The element that shows the message about the offer
    function offerExpires(today) { // Declare variables within the function for local scope
        var weekFromToday, day, date, month, year, dayNames, monthNames;    // Add 7 days time (added in milliseconds) 
        weekFromToday = new Date(today.getTime() + 7 * 24 * 60 * 60 * 1000);  // Create arrays to hold the names of days / months
